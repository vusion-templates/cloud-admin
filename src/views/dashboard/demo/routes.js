    ...
    children: [
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: 'echarts',
                    component: () => import(/* webpackChunkName: 'demo' */ './views/charts/echarts.vue'),
                    meta: {
                        title: 'ECharts',
                        crumb: 'ECharts',
                    },
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: 'code',
                    component: () => import(/* webpackChunkName: 'demo' */ './views/editors/code.vue'),
                    meta: {
                        title: '代码编辑器',
                        crumb: '代码编辑器',
                    },
                    children: [
                        ...
                        {
                            path: 'brace',
                            component: () => import(/* webpackChunkName: 'demo' */ './views/editors/code-brace.vue'),
                            meta: {
                                title: '代码编辑器(Brace)',
                                crumb: '代码编辑器(Brace)',
                            },
                        ...
                        {
                            path: 'monaco',
                            component: () => import(/* webpackChunkName: 'demo' */ './views/editors/code-monaco.vue'),
                            meta: {
                                title: '代码编辑器(Monaco)',
                                crumb: '代码编辑器(Monaco)',
                            },
                ...
                {
                    path: 'markdown',
                    component: () => import(/* webpackChunkName: 'demo' */ './views/editors/markdown.vue'),
                    meta: {
                        title: 'Markdown 编辑器',
                        crumb: 'Markdown 编辑器',
                    },
                ...
                {
                    path: 'rich-editor',
                    component: () => import(/* webpackChunkName: 'demo' */ './views/editors/rich-editor.vue'),
                    meta: {
                        title: '富文本编辑器',
                        crumb: '富文本编辑器',
                    },
